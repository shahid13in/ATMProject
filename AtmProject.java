...
class Account
{
    ...
    private int CN;
    private int PN;
    private double CB = 10000;
    private double SB = 10000;
    ...
    void getLogin()
    {
        ...
        do
        {
            try
            {
                ...
                System.out.println("$ WELCOME TO THE SHAHID'S ATM $...! ");
    ...
    void getAccountType()
    {
        ...
        switch(choice)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Thank You for using this SHAHID'S ATM, Visit again.....!"+"\n");
                break;
            default:
